...
public class Constants {
	...
	public static Map<String, Person> AGENTSMAP = new TreeMap<String, Person>();
	...
	/** Probability that the agent disobey the social isolation. */
	public static final float PROB_DISOBEY_SOCIAL_ISOLATION = 0.5f;

	/** Probability that the agent has covid at the beginning of the simulation. */
	public static final float PROB_HAS_COVID = 0.05f;
	...
	static class Fields {
		...
		/** Agent has Covid. */
		public static final String HAS_COVID = "Has Covid";

		/** Agent had Covid. */
		public static final String HAD_COVID = "Had Covid";

		/** Agent is suspect of having Covid. */
		public static final String SUSPECT_COVID = "Suspect Covid";

		/** Consecutive iterations in contact with Covid patient. */
		public static final String ITER_CONTACT_COVID = "Iterations in Contact with Covid";
		...
		/** Whether the agent disobeys the social isolation. */
		public static final String IS_DISOBEY = "Disobeys Social Isolation";
	...
	enum Risk implements Publishable {
		...
		private Risk(final String desc) { this.desc = desc;}

		@Override
		public FlatData flatten() {
			return new Text(desc).flatten();
		}
	}
